/**
 * @file
 * @brief JbController Core A9_0 Core class definition
 *
 *
 * @note
...
#ifndef JB_CONTROLLER_A9_0_HPP_
...
public:
	...
	static void startA91Core(uint32_t imageAddress);
